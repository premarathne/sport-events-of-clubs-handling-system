...
export const updateEvent = (eventID,updateEvent) => {
  return axios
    .post('http://localhost:5000/newevent/update/' + eventID, updateEvent)
    .then(response => {
...
export const sendEmails = (eventID,data) => {
   return axios
     .post('http://localhost:5000/newevent/send/'+eventID, data)
     .then(response => {
